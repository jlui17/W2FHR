...
export async function fetchData(): Promise<SchedulingData> {
  const data: unknown = {
    ...
    showMonday: false,
    startOfWeek: new Date("Friday, November 1, 2024"),
...
export function getDefaultNewGamesScheduleFormData(): NewScheduleSchemaFormData {
  return {
    rows: [
      ...Array.from(
        [
...
export function getDefaultNewWWScheduleFormData(): NewScheduleSchemaFormData {
  return {
    rows: [
      ...Array.from(
        [
